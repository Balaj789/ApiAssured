...
public class Excel {
  ...
  public void init() {
	  ...
	  report=new ExtentReports("C:\\Users\\BALAJRAO\\OneDrive - Capgemini\\Desktop\\Jai sree ram\\RestAssuredDemo\\target\\report.html");
	  test=report.startTest("User is Creating");
  }
  @Test(priority=-1)
  public void getData() {
  ...
  public void addData() throws IOException {
	  file=new File("C:\\Users\\BALAJRAO\\OneDrive - Capgemini\\Desktop\\Jai sree ram\\RestAssuredDemo\\src\\test\\resource\\Excel sheet.xlsx");
	 ...
	 // String name=p.getProperty("name");
	  ...
	  JSONObject obj=new JSONObject();
		...
		if(job.equals(job1)) {
			test.log(LogStatus.PASS,"Valid");
		}
		else {
			test.log(LogStatus.FAIL, "Invalid");
		}
  }
  @AfterTest
